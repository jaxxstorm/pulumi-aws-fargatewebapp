...
namespace Pulumi.Fargatewebapp
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Fargatewebapp.version.txt");
    ...
    internal sealed class FargatewebappResourceTypeAttribute : Pulumi.ResourceTypeAttribute
    {
        public FargatewebappResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
