module github.com/jaxxstorm/pulumi-aws-fargatewebapp/examples/go

go 1.17

require (
	github.com/jaxxstorm/pulumi-aws-fargatewebapp/sdk v0.0.0
...
replace github.com/jaxxstorm/pulumi-aws-fargatewebapp/sdk => ../../sdk
